...
/**
 * Base class that represents a row from the 'macro' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Macro implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MacroTableMap';
    ...
    /**
     * Initializes internal state of Base\Macro object.
     */
    ...
    /**
     * Compares this with another <code>Macro</code> instance.  If
     * <code>obj</code> is an instance of <code>Macro</code>, delegates to
     * <code>equals(Macro)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Macro The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MacroTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[MacroTableMap::COL_NOME] = true;
        }
    ...
    public function setZabbixid($v)
    {
        ...
        if ($this->zabbixid !== $v) {
            $this->zabbixid = $v;
            $this->modifiedColumns[MacroTableMap::COL_ZABBIXID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MacroTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MacroTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MacroTableMap::translateFieldName('Zabbixid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MacroTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Macro'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMacroQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMacroQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MacroTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MacroTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MacroTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('macro_id_seq')");
        ...
        if ($this->isColumnModified(MacroTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MacroTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(MacroTableMap::COL_ZABBIXID)) {
            $modifiedColumns[':p' . $index++]  = 'zabbixid';
        }

        $sql = sprintf(
            'INSERT INTO macro (%s) VALUES (%s)',
    ...
    {
        $pos = MacroTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Macro'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Macro'][$this->hashCode()] = true;
        $keys = MacroTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Macro The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(MacroTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MacroTableMap::COL_ID)) {
            $criteria->add(MacroTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MacroTableMap::COL_NOME)) {
            $criteria->add(MacroTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(MacroTableMap::COL_ZABBIXID)) {
            $criteria->add(MacroTableMap::COL_ZABBIXID, $this->zabbixid);
        }
    ...
    {
        $criteria = ChildMacroQuery::create();
        $criteria->add(MacroTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Macro (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Macro Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMacro is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMacro The current object (for fluent API support)
     */
    public function setMacroSchedules(Collection $macroSchedules, ConnectionInterface $con = null)
    {
        ...
        foreach ($macroSchedulesToDelete as $macroScheduleRemoved) {
            $macroScheduleRemoved->setMacro(null);
        }
     ...
     * Otherwise if this Macro is new, it will return
     * an empty collection; or if this Macro has previously
     * been saved, it will retrieve related MacroSchedules from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Macro.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(MacroTableMap::DEFAULT_STRING_FORMAT);
    }
