...
/**
 * Base class that represents a row from the 'log_delete_grupo_schedule' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class LogDeleteGrupoSchedule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LogDeleteGrupoScheduleTableMap';
    ...
    /**
     * Initializes internal state of Base\LogDeleteGrupoSchedule object.
     */
    ...
    /**
     * Compares this with another <code>LogDeleteGrupoSchedule</code> instance.  If
     * <code>obj</code> is an instance of <code>LogDeleteGrupoSchedule</code>, delegates to
     * <code>equals(LogDeleteGrupoSchedule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\LogDeleteGrupoSchedule The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LogDeleteGrupoScheduleTableMap::COL_ID] = true;
        }
    ...
    public function setGrupoScheduleId($v)
    {
        ...
        if ($this->grupo_schedule_id !== $v) {
            ...
            $this->modifiedColumns[LogDeleteGrupoScheduleTableMap::COL_GRUPO_SCHEDULE_ID] = true;
        }
    ...
    public function setLogId($v)
    {
        ...
        if ($this->log_id !== $v) {
            $this->log_id = $v;
            $this->modifiedColumns[LogDeleteGrupoScheduleTableMap::COL_LOG_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LogDeleteGrupoScheduleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LogDeleteGrupoScheduleTableMap::translateFieldName('GrupoScheduleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->grupo_schedule_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LogDeleteGrupoScheduleTableMap::translateFieldName('LogId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = LogDeleteGrupoScheduleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LogDeleteGrupoSchedule'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLogDeleteGrupoScheduleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LogDeleteGrupoSchedule::setDeleted()
     * @see LogDeleteGrupoSchedule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLogDeleteGrupoScheduleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LogDeleteGrupoScheduleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('log_delete_grupo_schedule_id_seq')");
        ...
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_GRUPO_SCHEDULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'grupo_schedule_id';
        }
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_LOG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'log_id';
        }

        $sql = sprintf(
            'INSERT INTO log_delete_grupo_schedule (%s) VALUES (%s)',
    ...
    {
        $pos = LogDeleteGrupoScheduleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LogDeleteGrupoSchedule'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LogDeleteGrupoSchedule'][$this->hashCode()] = true;
        $keys = LogDeleteGrupoScheduleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\LogDeleteGrupoSchedule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\LogDeleteGrupoSchedule The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_ID)) {
            $criteria->add(LogDeleteGrupoScheduleTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_GRUPO_SCHEDULE_ID)) {
            $criteria->add(LogDeleteGrupoScheduleTableMap::COL_GRUPO_SCHEDULE_ID, $this->grupo_schedule_id);
        }
        if ($this->isColumnModified(LogDeleteGrupoScheduleTableMap::COL_LOG_ID)) {
            $criteria->add(LogDeleteGrupoScheduleTableMap::COL_LOG_ID, $this->log_id);
        }
    ...
    {
        $criteria = ChildLogDeleteGrupoScheduleQuery::create();
        $criteria->add(LogDeleteGrupoScheduleTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LogDeleteGrupoSchedule (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LogDeleteGrupoSchedule Clone of current object.
     * @throws PropelException
     */
    ...
    public function setGrupoSchedule(ChildGrupoSchedule $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLogDeleteGrupoSchedule($this);
        }
    ...
    public function getGrupoSchedule(ConnectionInterface $con = null)
    {
        if ($this->aGrupoSchedule === null && ($this->grupo_schedule_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGrupoSchedule->addLogDeleteGrupoSchedules($this);
             */
        }
    ...
    public function getLog(ConnectionInterface $con = null)
    {
        if ($this->aLog === null && ($this->log_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLog->addLogDeleteGrupoSchedules($this);
             */
        }
    ...
    {
        if (null !== $this->aGrupoSchedule) {
            $this->aGrupoSchedule->removeLogDeleteGrupoSchedule($this);
        }
        if (null !== $this->aLog) {
            $this->aLog->removeLogDeleteGrupoSchedule($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(LogDeleteGrupoScheduleTableMap::DEFAULT_STRING_FORMAT);
    }
