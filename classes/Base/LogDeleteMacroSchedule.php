...
/**
 * Base class that represents a row from the 'log_delete_macro_schedule' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class LogDeleteMacroSchedule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LogDeleteMacroScheduleTableMap';
    ...
    /**
     * Initializes internal state of Base\LogDeleteMacroSchedule object.
     */
    ...
    /**
     * Compares this with another <code>LogDeleteMacroSchedule</code> instance.  If
     * <code>obj</code> is an instance of <code>LogDeleteMacroSchedule</code>, delegates to
     * <code>equals(LogDeleteMacroSchedule)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\LogDeleteMacroSchedule The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LogDeleteMacroScheduleTableMap::COL_ID] = true;
        }
    ...
    public function setMacroScheduleId($v)
    {
        ...
        if ($this->macro_schedule_id !== $v) {
            ...
            $this->modifiedColumns[LogDeleteMacroScheduleTableMap::COL_MACRO_SCHEDULE_ID] = true;
        }
    ...
    public function setLogId($v)
    {
        ...
        if ($this->log_id !== $v) {
            $this->log_id = $v;
            $this->modifiedColumns[LogDeleteMacroScheduleTableMap::COL_LOG_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LogDeleteMacroScheduleTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LogDeleteMacroScheduleTableMap::translateFieldName('MacroScheduleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->macro_schedule_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LogDeleteMacroScheduleTableMap::translateFieldName('LogId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = LogDeleteMacroScheduleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LogDeleteMacroSchedule'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLogDeleteMacroScheduleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LogDeleteMacroSchedule::setDeleted()
     * @see LogDeleteMacroSchedule::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLogDeleteMacroScheduleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LogDeleteMacroScheduleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('log_delete_macro_schedule_id_seq')");
        ...
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_MACRO_SCHEDULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'macro_schedule_id';
        }
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_LOG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'log_id';
        }

        $sql = sprintf(
            'INSERT INTO log_delete_macro_schedule (%s) VALUES (%s)',
    ...
    {
        $pos = LogDeleteMacroScheduleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LogDeleteMacroSchedule'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LogDeleteMacroSchedule'][$this->hashCode()] = true;
        $keys = LogDeleteMacroScheduleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\LogDeleteMacroSchedule
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\LogDeleteMacroSchedule The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_ID)) {
            $criteria->add(LogDeleteMacroScheduleTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_MACRO_SCHEDULE_ID)) {
            $criteria->add(LogDeleteMacroScheduleTableMap::COL_MACRO_SCHEDULE_ID, $this->macro_schedule_id);
        }
        if ($this->isColumnModified(LogDeleteMacroScheduleTableMap::COL_LOG_ID)) {
            $criteria->add(LogDeleteMacroScheduleTableMap::COL_LOG_ID, $this->log_id);
        }
    ...
    {
        $criteria = ChildLogDeleteMacroScheduleQuery::create();
        $criteria->add(LogDeleteMacroScheduleTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LogDeleteMacroSchedule (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LogDeleteMacroSchedule Clone of current object.
     * @throws PropelException
     */
    ...
    public function setLog(ChildLog $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLogDeleteMacroSchedule($this);
        }
    ...
    public function getLog(ConnectionInterface $con = null)
    {
        if ($this->aLog === null && ($this->log_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLog->addLogDeleteMacroSchedules($this);
             */
        }
    ...
    public function getMacroSchedule(ConnectionInterface $con = null)
    {
        if ($this->aMacroSchedule === null && ($this->macro_schedule_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMacroSchedule->addLogDeleteMacroSchedules($this);
             */
        }
    ...
    {
        if (null !== $this->aLog) {
            $this->aLog->removeLogDeleteMacroSchedule($this);
        }
        if (null !== $this->aMacroSchedule) {
            $this->aMacroSchedule->removeLogDeleteMacroSchedule($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(LogDeleteMacroScheduleTableMap::DEFAULT_STRING_FORMAT);
    }
