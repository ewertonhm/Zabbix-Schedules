...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_ENABLED = 'usuario.enabled';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Nome', 'Senha', 'Admin', 'Enabled', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'nome', 'senha', 'admin', 'enabled', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_LOGIN, UsuarioTableMap::COL_NOME, UsuarioTableMap::COL_SENHA, UsuarioTableMap::COL_ADMIN, UsuarioTableMap::COL_ENABLED, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'nome', 'senha', 'admin', 'enabled', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Nome' => 2, 'Senha' => 3, 'Admin' => 4, 'Enabled' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'nome' => 2, 'senha' => 3, 'admin' => 4, 'enabled' => 5, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_LOGIN => 1, UsuarioTableMap::COL_NOME => 2, UsuarioTableMap::COL_SENHA => 3, UsuarioTableMap::COL_ADMIN => 4, UsuarioTableMap::COL_ENABLED => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'nome' => 2, 'senha' => 3, 'admin' => 4, 'enabled' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'login' => 'LOGIN',
        'usuario.login' => 'LOGIN',
        'UsuarioTableMap::COL_LOGIN' => 'LOGIN',
        'COL_LOGIN' => 'LOGIN',
        'Nome' => 'NOME',
        'Usuario.Nome' => 'NOME',
        'nome' => 'NOME',
        ...
        'enabled' => 'ENABLED',
        'usuario.enabled' => 'ENABLED',
        'UsuarioTableMap::COL_ENABLED' => 'ENABLED',
        'COL_ENABLED' => 'ENABLED',
    ];
    ...
    public function initialize()
    {
        ...
        $this->addColumn('admin', 'Admin', 'VARCHAR', false, 1, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_ENABLED);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(UsuarioTableMap::COL_LOGIN);
            ...
            $criteria->removeSelectColumn(UsuarioTableMap::COL_ENABLED);
        } else {
